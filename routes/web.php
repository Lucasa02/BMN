...
use App\Http\Controllers\User\TeknisiController;
...
Route::prefix('admin')->group(function () {
  ...
  Route::prefix('perawatan')->name('perawatan_inventaris.')->group(function () {
    ...
    Route::get('/perbaiki/{id}', [PerawatanInventarisController::class, 'perbaikiForm'])->name('perbaiki');
    Route::post('/perbaiki/{id}/submit', [PerawatanInventarisController::class, 'perbaikiSubmit'])->name('perbaikiSubmit');
    Route::get('/hapuskan/{id}', [PerawatanInventarisController::class, 'hapuskan'])->name('hapuskan');
    Route::post('/verifikasi/{id}', [PerawatanInventarisController::class, 'verifikasiSelesai'])->name('verifikasiSelesai');
  });
...
Route::prefix('user/teknisi')->middleware(['auth', 'role:tim_perbaikan'])->name('user.teknisi.')->group(function () {
    ...
    Route::post('/proses/{uuid}', [TeknisiController::class, 'proses'])->name('proses');
    Route::get('/logbook', [TeknisiController::class, 'logbook'])->name('logbook');
    Route::get('/logbook/pdf', [TeknisiController::class, 'downloadPdf'])->name('logbook.pdf');
});
