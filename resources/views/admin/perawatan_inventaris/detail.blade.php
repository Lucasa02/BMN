                ...
                <div class="space-y-8">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div class="bg-blue-50/50 p-4 rounded-2xl border border-blue-100">
                            <label class="block text-[10px] font-bold uppercase tracking-widest text-blue-400 mb-1">Ditangani Oleh (Teknisi)</label>
                    ...
                    {{-- Deskripsi --}}
                    <div>
                        <label class="block text-xs font-bold uppercase tracking-widest text-slate-400 mb-2">Riwayat & Catatan Teknisi</label>
                        ...
                        @if ($data->foto_bukti)
                            <div class="group relative overflow-hidden rounded-3xl shadow-lg border-4 border-white aspect-[4/3] w-full">
                                ...
                                <div class="absolute inset-0 bg-gradient-to-t from-[#1b365d]/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-center pb-4">
                                    <span class="text-white text-xs font-bold tracking-wider uppercase"><i class="fa-solid fa-image mr-1"></i> Bukti Teknisi</span>
                                </div>
                            </div>
                        @else
